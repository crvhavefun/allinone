...
<body>
    <noscript>
<center><b>Your browser does not support JavaScript!</b></center>
    </noscript>
    <form id="form1" runat="server">
    <div style="text-align: center">
        <asp:ScriptManager ID="ScriptManager1" runat="server">
        </asp:ScriptManager>
        <strong>華潤零售報表系統(門店)</strong><table align="center" bgcolor="#F7F7F7" 
                        ...
                        <tr>
                            <td colspan="2" style="text-align: left">
                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                    <ContentTemplate>
                                        <asp:TextBox ID="TB_UserID" runat="server" Enabled="False" MaxLength="12" 
                        ...
                        <tr>
                            <td colspan="2" style="text-align: left">
                                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                    <ContentTemplate>
                                        <asp:TextBox ID="TB_UserPw" runat="server" 
                        ...
                        <tr>
                            <td style="text-align: left">
                                <asp:Button ID="Button1" runat="server" BackColor="Black" BorderStyle="None" 
                                    ...
                                    Height="35px" onclick="Button1_Click" onclientclick="hashPassword()" 
                                    Text="LOGIN" />
                            </td>
