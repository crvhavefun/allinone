<%@ Page Title="" Language="C#" MasterPageFile="~/RPS.Master" AutoEventWireup="true" CodeBehind="R240301_HBASalesByShopType.aspx.cs" Inherits="RPS.modules.R2403.R240301_HBASalesByShopType1" %>
    ...
    <table border="1" style="width: 600px; border-collapse: collapse;">
        <tr>
            <td class="style2" colspan="4">
                <strong>R240301 HBA Sales By Shop Type</strong></td>
        </tr>
        <tr>
            <td class="style2">
                Start Date: (Y-M-D)</td>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <asp:UpdateProgress ID="UpdateProgress1" runat="server" DisplayAfter="0">
                <ProgressTemplate>
                    <img class="style4" src="../../images/ajax-loader.gif" />
                </ProgressTemplate>
            </asp:UpdateProgress>
        </ContentTemplate>
        <Triggers>
